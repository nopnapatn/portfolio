          ...
          <CardContent>
            <div className="mt-4">
              <p className="text-sm text-paleOyster">
                ...
                I specialize in building web applications and have professional
                experience working with TypeScript, React, and Node.js. I am
                also a writer and write about web development, programming, and
              ...
              <p className="mt-3 text-sm text-paleOyster">
                ...
                entrepreneurship, and business development. I am also looking to
                collaborate with other developers, designers, and product
